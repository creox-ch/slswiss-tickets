...
## Текущий спринт
См. «🔴 ГДЕ МЫ СЕЙЧАС» в STATE.md. Кратко: стенд работает (билет+сканер через dev/issue); оплата Payrexx блокирована активацией платёжного провайдера (PSP) в кабинете (ошибка 422). Часть 2 ТЗ (Stripe-подписка SLS) не реализована.
