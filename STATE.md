...
> Принцип: **реальность (git/деплой/код на диске) важнее заметок.** Блок «ГДЕ МЫ СЕЙЧАС» сверен с кодом и базой 2026-08-10; разделы ниже — с кодом 2026-07-20.
...
- **Часть 2 ТЗ — подписка SLS 19 CHF/мес** не реализована. Решение 2026-07-03: делать на Payrexx, не на Stripe.
