...
- ⚠ **Живой оплатой после апгрейда не проверяли.** Сборка, 218 тестов и preview-деплой зелёные, но платёжный контур на проде прогонит только реальная покупка — та самая, что и так висит в «Срочном».
