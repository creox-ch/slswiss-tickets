...
export function renderSpeakerHtml(sub) {
  ...
  return emailShell({
    ...
    footerNoteHtml: `Ты получил(а) это письмо, потому что оставил(а) анкету спикера на <a href="${forum}/speakers.html" style="color:#7A6C93">frankenplatz.ch</a>.`,
  });
}
