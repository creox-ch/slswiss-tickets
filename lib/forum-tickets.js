...
/**
 * Категории рядов: подпись, ряды и число мест. Справочные данные — код по ним
 * ничего не считает и продажу не ограничивает; источник истины для покупателя —
 * карточки на frankenplatz.ch/tickets и страница оплаты, и расходиться с ними
 * нельзя (до 05.09.2026 здесь стояла прежняя схема зала: 30/45/225 и другие ряды).
 */
export const CATEGORIES = {
  vip: { label: 'VIP', rows: '1–3', limit: 45 },
  premium: { label: 'Premium', rows: '4–8', limit: 75 },
  standard: { label: 'Standard', rows: '9–20', limit: 180 },
};
