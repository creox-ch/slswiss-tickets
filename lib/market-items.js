...
const ACTIONS = {
  ...
  withdraw: 'withdrawn',
  draft: 'draft',
  // Отметка о продаже. В отличие от остальных действий, требует данных сделки
  // (цена и где продано) — их разбирает lib/market-commission.js. Это учётная
  // запись, а не смена состояния: на ней считается комиссия (AGB 5.5, 5.6).
  sold: 'sold',
};
